...
function onjwplayer(link,captions,nextid) {
    var plugins = "timeslidertooltipplugin,http://phim-vn.com/player/plugins/proxy.swf,"+base_url+"/content/template/jwplayer/captions.swf",
        player = "http://phim-vn.com/player/jwhplayer.swf",
		skin = base_url+"/content/template/jwplayer/skin/skins.xml";
    jwplayer("rkplayer").setup({
        flashplayer: player,
        plugins: plugins,
        "proxy.link": link,
		"logo.file": "http://phim-vn.com/player/logo.png",
        "logo.hide": "false",
