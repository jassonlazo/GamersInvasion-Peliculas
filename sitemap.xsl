			...
			<body>
				...
				<div id="intro">
					<p>
						...
						Generated by Vao8 - fb.com/vao8 - <a href="http://facebook.com/SieuAnhHungTraiDat/" target="_blank">Vao8 V1.0</a>.<br/>
				...
				<div id="footer">
					Vao8 sitemap - Generated by Vao8 - fb.com/vao8 - <a href="http://facebook.com/SieuAnhHungTraiDat" target="_blank">Vao8</a>
				</div>
			</body>
		</html>
	</xsl:template>
